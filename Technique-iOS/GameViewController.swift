...
class GameViewController: UIViewController, SCNSceneRendererDelegate {
    ...
    override func viewDidLoad() {
        ...
        let gesture2 = UIPinchGestureRecognizer(target: self, action:  #selector(pinchDetected))
    ...
    func renderer( aRenderer: SCNSceneRenderer, willRenderScene scene: SCNScene, atTime time: TimeInterval) {
        ...
        if(!received){
            ...
            //print(point2.stringByReplacingOccurrencesOfString(" ", withString: "\n", options: NSString.CompareOptions.CaseInsensitiveSearch, range: nil))
    ...
    @IBAction func selectedTechnique(_ sender: UISegmentedControl) {
        print(" Any ")
    ...
    func generateReversedBox(blender : Bool) -> SCNNode{
        ...
        let nor = SCNGeometrySource(data: NSData(bytes: norcoords, length:12*24) as Data , semantic:SCNGeometrySource.Semantic.normal, vectorCount: 24, usesFloatComponents: true, componentsPerVector: 3, bytesPerComponent: 4, dataOffset: 0, dataStride: 0)
